# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 13:21:36 2019
...
if __name__ == '__main__':
    ...
    http_proxy = HttpProxy("LTAImYykkcHFVykZ", "wEPBRWgCuCRkMaJETQF0JAxEyqA2Ma", "chat")
    # 读取文档 
    sound_wav_rb = http_proxy.read_file("北京科技馆.pcm")
    # 这里的参数详见文档
    response = http_proxy.send_request(sound_wav_rb, "pcm", 16000, "https://nlsapi.aliyun.com/recognize?")
    print(response)